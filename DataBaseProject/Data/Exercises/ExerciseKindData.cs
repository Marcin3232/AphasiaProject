...
namespace DataBaseProject.Data.Exercises
{
    public class ExerciseKindData
    {
        ...
        private List<ExerciseKindModel> CreateList()
        {
            ...
            temp.Add(Create(23, _exerciseKindNameData.GetKindName(23)));
            ...
            temp.Add(Create(29, _exerciseKindNameData.GetKindName(29)));
            temp.Add(Create(30, _exerciseKindNameData.GetKindName(30)));
            return temp;
        }
